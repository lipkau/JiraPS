...
Describe "Remove-JiraIssueAttachment" -Tag 'Unit' {
    ...
    Describe "Sanity checking" {
        ...
        It "has a parameter 'AttachmentId' of type [Int[]]" {
            $command | Should -HaveParameter "AttachmentId" -Type [Int[]]
        }

        It "has an alias 'Id' for parameter 'Issue" {
            $command | Should -HaveParameter "Issue" -Alias "Id"
        }
        ...
        It "has a parameter 'FileName' of type [String[]]" {
            $command | Should -HaveParameter "FileName" -Type [String[]]
        }
