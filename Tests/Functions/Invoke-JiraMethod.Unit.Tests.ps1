...
"@
    ...
    Mock Invoke-WebRequest -ModuleName JiraPS {
        Write-MockInfo 'Invoke-JiraMethod' @{ Method = $Method; Uri = $Uri; Headers = $Headers; ContentType = $ContentType; SessionVariable = $SessionVariable; WebSession = $WebSession }
    ...
    Describe "Sanity checking" {
        ...
        It "has a parameter 'Method' of type [Microsoft.PowerShell.Commands.WebRequestMethod]" {
            $command | Should -HaveParameter "Method" -Type [Microsoft.PowerShell.Commands.WebRequestMethod]
        }

        It "has a parameter 'Body' of type [String]" {
            $command | Should -HaveParameter "Body" -Type [String]
        }

        It "has a parameter 'RawBody' of type [Switch]" {
            $command | Should -HaveParameter "RawBody" -Type [Switch]
        }
        ...
        It "has a parameter 'GetParameter' of type [Hashtable]" {
            $command | Should -HaveParameter "GetParameter" -Type [Hashtable]
        }

        It "has a parameter 'Paging' of type [Switch]" {
            $command | Should -HaveParameter "Paging" -Type [Switch]
        }

        It "has a parameter 'InFile' of type [String]" {
            $command | Should -HaveParameter "InFile" -Type [String]
        }

        It "has a parameter 'OutFile' of type [String]" {
            $command | Should -HaveParameter "OutFile" -Type [String]
        }

        It "has a parameter 'StoreSession' of type [Switch]" {
            $command | Should -HaveParameter "StoreSession" -Type [Switch]
        }

        It "has a parameter 'OutputType' of type [String]" {
            $command | Should -HaveParameter "OutputType" -Type [String]
        }
        ...
        It "has a parameter 'CmdLet' of type [System.Management.Automation.PSCmdlet]" {
            $command | Should -HaveParameter "CmdLet" -Type [System.Management.Automation.PSCmdlet]
        }
    }
