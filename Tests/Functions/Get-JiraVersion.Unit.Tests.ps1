...
"@
    ...
    Describe "Sanity checking" {
        ...
        It "has a parameter 'Id' of type [Int[]]" {
            $command | Should -HaveParameter "Id" -Type [Int[]]
        }
        ...
        It "has a parameter 'Credential' of type [String[]]" {
            $command | Should -HaveParameter "Credential" -Type [String[]]
        }

        It "has an alias 'Key' for parameter 'Project" {
            $command | Should -HaveParameter "Project" -Alias "Key"
        }

        It "has a parameter 'InputProject' of type [Object]" {
            $command | Should -HaveParameter "InputProject" -Type [Object]
        }
